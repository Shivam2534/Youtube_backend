...
const LogOutUser = asyncHandler(async (req, res) => {
  ...
  // console.log("Request Received at logout function")
  ...
  // console.log("Now we are sending data")
...
const getUserChannelProfileById = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new apiResponse(200, channel[0], "channel Fetched Successfully By UserId")
    );
});

const Push_video_to_WatchHistory = asyncHandler(async (req, res) => {
  ...
  if (!user) {
    throw new ApiError(402, "UnAuthorised user| Please login");
  }
  ...
  console.log("Video Data after Update:", video);

  return res
    .status(200)
    .json(new apiResponse(200, user, "WatchHistory updated Successfully"));
});

const getwatchHistory = asyncHandler(async (req, res) => {
  console.log("Request received for Get Watch History");
...
const GetSpecificUser = asyncHandler(async (req, res) => {
  ...
  if (!user) {
    throw new ApiError(402, "Not User Found With this Id");
  }

  return res
    .status(200)
    .json(new apiResponse(200, user, "User Avatar fetched successfully"));
});
