...
router.route("/getchannelbyId/:_id").get(verifyJWT,getUserChannelProfileById);
router.route("/Push_video_to_WatchHistory/:videoId").post(verifyJWT, Push_video_to_WatchHistory);
router.route("/watchHistory").get(verifyJWT, getwatchHistory);
router.route("/GetSpecificUser/:userId").get(GetSpecificUser);
